...
2. Run `git log --oneline <default-branch>..HEAD` to list all commits on the current branch.
3. Run `git diff <default-branch>...HEAD` to get the full diff.
4. Analyze the commits and diff, then draft a PR title and description.
